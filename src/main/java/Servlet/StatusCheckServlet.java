...
//            int applicantId = applicantDAO.getApplicantIdByUsername(username);
         ...
         // 错误信息并添加跳转按钮，居中展示
            ...
            response.getWriter().println("<h1 style=\"color: red;\">同学您尚未注册，请点击按钮注册	</h1>");
            response.getWriter().println("<br><br>");
            response.getWriter().println("<button style=\"font-size: 18px; padding: 10px 20px; background-color: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer;\" onclick=\"window.location.href='Test-exist.jsp'\">点击跳转到个人注册页面</button>");
